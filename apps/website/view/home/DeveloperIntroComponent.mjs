    ...
    static config = {
        ...
        vdom: {innerHTML: [
            '<div class="neo-absolute">',
                ...
                '</p>',
                '<p>',
                    '<a target="_blank" href="https://github.com/neo.mjs/neo/issues">neo.mjs issues tracker</a>',
                '</p>',
                '<p>',
                ...
                '</p>',
                '<p>',
                    'For more information, please review our contribution guide <a target="_blank" href="https://github.com/neo.mjs/neo/blob/dev/CONTRIBUTING.md">here</a>.',
                '</p>',
